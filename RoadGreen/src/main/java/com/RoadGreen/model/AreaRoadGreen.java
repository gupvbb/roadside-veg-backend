...
@Entity
@Table(name = "areas_roadgreen")
public class AreaRoadGreen {
    ...
    public AreaRoadGreen() {
        this.criadoEm = LocalDateTime.now();
        this.atualizadoEm = LocalDateTime.now();
        this.status = StatusVegetacao.NORMAL;
    }

    public AreaRoadGreen(String codigo, String rodovia, Double kmInicial, Double kmFinal,
